...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (markdown-mode markdown-mode+ dashboard magit use-package yaml-mode cask-mode pallet company swiper flycheck counsel smartparens docbook popwin elfeed powerline moe-theme adoc-mode js2-mode web-mode nodejs-repl exec-path-from-shell)))
